...
import modell.exceptions.BoardSaveException;
 ...
 *     <li>Special tiles: An array of tile configurations,
 *     each containing a tile number and its ladder value</li>
 * </ul>
 *
...
public class BoardFileSaver {
   ...
   */
  public static void saveBoard(GameboardLogic gameboardLogic, LadderTileLogic
      tileLogic, String filePath)
      throws BoardSaveException {
    try (FileWriter writer = new FileWriter(filePath)) {
      JsonObject boardJson = serializeBoardConfig(gameboardLogic, tileLogic);
      writer.write(boardJson.toString());
    } catch (IOException e) {
      throw new BoardSaveException("Failed to save board configuration to JSON file: "
          + filePath, e);
    }
  }
   ...
   */
  private static JsonObject serializeBoardConfig(GameboardLogic gameboardLogic,
                                                 LadderTileLogic tileLogic) {
